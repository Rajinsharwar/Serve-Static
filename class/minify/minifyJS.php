 ...
 * file at: https://github.com/tedious/JShrink/blob/master/LICENSE
 */
...
class Minifier {
    ...
    protected function processMultiLineComments($startIndex)
    {
        ...
        if ($char === false) {
            ...
            $message = 'Unclosed multiline comment at position: ' . $position;
            throw new \RuntimeException(esc_attr($message));
        }        
            ...
            switch ($this->a) {
                ...
                case "\n":
                    if ($stringType === '`') {
                        ...
                        $position = $startpos;
                        $message = 'Unclosed string at position: ' . $position;
                        throw new \RuntimeException(esc_attr($message));
                    }                    
                    break;
